...
strictfp class Real extends Number {
  ...
  public double doubleValue() {
    // Since the components are guaranteed to have no overlapping digits, we could simply sum them
    // without loss of precision... but to return a double we truncate to the 53 bits of the largest
    // exponent.
    double sum = 0;
