...
public interface S2LaxPolylineShape extends S2ShapeAspect.EdgeAspect.Open {
   ...
   * FAST} format.
   */
  public S2Coder<S2LaxPolylineShape> FAST_CODER = S2PointVectorCoder.FAST.delegating(
      S2LaxPolylineShape::vertices, SimpleList::new);

  /**
   * An instance of {@link S2Coder} which encodes/decodes {@link S2LaxPolylineShape}s in the {@code
   * COMPACT} format.
   */
  public S2Coder<S2LaxPolylineShape> COMPACT_CODER = S2PointVectorCoder.COMPACT.delegating(
      S2LaxPolylineShape::vertices, SimpleList::new);
