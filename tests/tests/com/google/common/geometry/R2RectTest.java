...
public class R2RectTest extends GeometryTestCase {
   ...
   */
  private static void testIntervalOps(
      R2Rect x,
      R2Rect y,
  ...
  public void testFromCenterSize() {
    ...
    assertTrue(
        R2Rect.fromCenterSize(new R2Vector(1, 0.1), new R2Vector(0, 2))
  ...
  public void testFromPoint() {
    ...
    assertEquals(
        new R2Rect(new R2Vector(0.15, 0.3), new R2Vector(0.35, 0.9)),
        R2Rect.fromPointPair(new R2Vector(0.15, 0.9), new R2Vector(0.35, 0.3)));
    assertEquals(
        new R2Rect(new R2Vector(0.12, 0), new R2Vector(0.83, 0.5)),
  ...
  public void testIntervalOperations() {
    ...
    testIntervalOps(
        r1,
        new R2Rect(new R2Vector(0.45, 0.1), new R2Vector(0.75, 0.3)),
        "FFTT",
        new R2Rect(new R2Vector(0, 0.1), new R2Vector(0.75, 0.75)),
        new R2Rect(new R2Vector(0.45, 0.25), new R2Vector(0.5, 0.3)));
    testIntervalOps(
        r1,
        new R2Rect(new R2Vector(0.5, 0.1), new R2Vector(0.7, 0.3)),
        "FFTF",
        new R2Rect(new R2Vector(0, 0.1), new R2Vector(0.7, 0.75)),
        new R2Rect(new R2Vector(0.5, 0.25), new R2Vector(0.5, 0.3)));
    testIntervalOps(
        r1,
        new R2Rect(new R2Vector(0.45, 0.1), new R2Vector(0.7, 0.25)),
        "FFTF",
        new R2Rect(new R2Vector(0, 0.1), new R2Vector(0.7, 0.75)),
        new R2Rect(new R2Vector(0.45, 0.25), new R2Vector(0.5, 0.25)));

    testIntervalOps(
        new R2Rect(new R2Vector(0.1, 0.2), new R2Vector(0.1, 0.3)),
        new R2Rect(new R2Vector(0.15, 0.7), new R2Vector(0.2, 0.8)),
        "FFFF",
    ...
    testIntervalOps(
        new R2Rect(new R2Vector(0.1, 0.2), new R2Vector(0.4, 0.5)),
        new R2Rect(new R2Vector(0, 0), new R2Vector(0.2, 0.1)),
        "FFFF",
        new R2Rect(new R2Vector(0, 0), new R2Vector(0.4, 0.5)),
        empty);
    testIntervalOps(
        new R2Rect(new R2Vector(0, 0), new R2Vector(0.1, 0.3)),
        new R2Rect(new R2Vector(0.2, 0.1), new R2Vector(0.3, 0.4)),
        "FFFF",
        new R2Rect(new R2Vector(0, 0), new R2Vector(0.3, 0.4)),
        empty);
  }
