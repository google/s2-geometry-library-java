...
public class S2CellIdVectorCoderTest extends TestCase {
  ...
  public void testMaximumShiftCell() throws IOException {
    // Tests the encoding of a single cell at level 2, which corresponds the maximum encodable shift
    // value (56).
  ...
  public void testOneByteRangeWithBaseValue() throws IOException {
    // Tests that cells can be encoded in one byte by choosing a base value  whose bit range
    // overlaps the delta values.
  ...
  public void testFractalS2ShapeIndexCells() throws IOException {
    ...
    S2Point center = GeometryTestCase.makePoint("47.677:-122.206");
