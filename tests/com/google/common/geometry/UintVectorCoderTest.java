...
public class UintVectorCoderTest extends TestCase {
  ...
  public void testDecodeFromByteString() {
    ...
    Bytes data = Bytes.fromByteArray(BaseEncoding.base16().decode("00000018000000"));
  ...
  private static List<Long> decodeUint64Vector(byte[] bytes) {
  ...
  private static List<Integer> decodeUint32Vector(byte[] bytes) {
    Bytes data = Bytes.fromByteArray(bytes);
