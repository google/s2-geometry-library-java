...
public strictfp class S1IntervalTest extends GeometryTestCase {
  ...
  public void testConstructorsAndAccessors() {
    ...
    assertEquals(quad12.lo(), 0d);
    assertEquals(quad12.hi(), S2.M_PI);
    assertEquals(quad34.get(0), S2.M_PI);
    assertEquals(quad34.get(1), 0d);
  ...
  public void testGetCenter() {
    ...
    assertEquals(new S1Interval(3.1, 2.9).getCenter(), 3.0 - S2.M_PI);
    assertEquals(new S1Interval(-2.9, -3.1).getCenter(), S2.M_PI - 3.0);
    assertEquals(new S1Interval(2.1, -2.1).getCenter(), S2.M_PI);
    assertEquals(pi.getCenter(), S2.M_PI);
    assertEquals(mipi.getCenter(), S2.M_PI);
    assertEquals(Math.abs(quad23.getCenter()), S2.M_PI);
    assertEquals(quad123.getCenter(), 0.75 * S2.M_PI);
  }

  public void testGetLength() {
    assertEquals(quad12.getLength(), S2.M_PI);
    assertEquals(pi.getLength(), 0d);
    assertEquals(mipi.getLength(), 0d);
    assertEquals(quad123.getLength(), 1.5 * S2.M_PI);
  ...
  public void testContains() {
    ...
    assertTrue(quad12.contains(0) && quad12.contains(S2.M_PI) &&
        quad12.contains(-S2.M_PI));
    assertTrue(quad12.interiorContains(S2.M_PI_2) && !quad12.interiorContains(0));
    assertTrue(!quad12.interiorContains(S2.M_PI) &&
    ...
    assertTrue(!quad23.interiorContains(S2.M_PI_2) &&
  ...
  private void testIntervalOps(S1Interval x, S1Interval y,
    ...
    assertEquals(x.union(y), expectedUnion);
    assertEquals(x.intersection(y), expectedIntersection);
  ...
  public void testApproxEquals() {
    ...
    assertFalse(new S1Interval(S2.M_PI - 0.5 * kLo, -S2.M_PI + 0.5 * kLo)
