...
/**
 * An S2RegionIntersection represents an intersection of overlapping regions.  It is convenient
 * for computing a covering of the intersection of a set of regions. The regions are assumed to be
...
public class S2RegionIntersection implements S2Region, Serializable {
  ...
  /**
   * Returns true if this S2RegionIntersection is equal to another S2RegionIntersection, where
   * each region must be equal and in the same order. This method is intended only for testing
   * purposes.
