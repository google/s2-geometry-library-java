...
public strictfp class S2CellUnion implements S2Region, Iterable<S2CellId>, Serializable {
   ...
   *
   * <p>This method allows a covering generated by S2RegionCoverer using
   ...
   * Canada by 1km).
   *
   * <p>For example, if maxLevelDiff == 4, the region will always be expanded by
   ...
   *
   * <p>Note that {@link S2Cell#averageArea()} does not take into account
   ...
   *
   * <p>This method *must* be called before doing any calculations on the cell
